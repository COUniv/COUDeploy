        ...
        <div class="left_announcement">
              ...
              <span
                >{{
                  contest_stat === ""
                    ...
                    : this.$i18n.t(
                        "m." +
                          CONTEST_STATUS_REVERSE[contest_stat].name.replace(
                            / /g,
                            "_"
                          )
                      )
          ...
          <div class="tab-content">
            ...
            <div v-show="currentTab == 0">
              ...
              >
                ...
                <div class="announcement-time">
                  {{ announcement.create_time | localtime("YYYY.MM.DD") }}
                </div>
            ...
            <div v-show="currentTab == 1">
              ...
              <div
                class="contest_title"
                v-for="(contest, contest_idx) in contests"
                :key="contest_idx"
                @click="goContest"
              >
    ...
    getContestList(page = 1) {
      api.getContestList(0, this.limit, this.query).then(res => {
        ...
        for (let v in notfiltercontests) {
          if (
            notfiltercontests[v].status === undefined ||
            notfiltercontests[v].status === null ||
            notfiltercontests[v].status === -1 ||
            notfiltercontests[v].status === "-1"
          ) {
            continue;
          }
...
.color-red {
  ...
  width: calc(
    95% - 170px
  ); // default size - left button size(90px) - times(80px)
  overflow: hidden;
  text-overflow: ellipsis;
  &:hover {
    cursor: pointer;
