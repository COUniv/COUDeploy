  ...
  <div class="free_board">
    <div class="community" style="float:left">
      ...
      <div class="community_menu">
        <!-- <Menu width="100%">
                    <MenuItem class="community_menu_list" name="/FreeBoard" to="/Free_Board">
                        자유 게시판
                    </MenuItem>
                    <MenuItem class="community_menu_list" name="/QuestionBoard" to="/Question_Board">
                        질문 게시판
                    </MenuItem>
                    <MenuItem class="community_menu_list" name="/RequestBoard" to="/Request_Board">
                        요청 게시판
                    </MenuItem>
                </Menu> -->
        <router-link to="/Free_Board"
          ><div class="community_menu_list" name="/FreeBoard">
            자유 게시판
          </div></router-link
        >
        <router-link to="/Question_Board"
          ><div class="community_menu_list_main" name="/QuestionBoard">
            질문 게시판
          </div></router-link
        >
    ...
    <div class="community_question" style="float:right">
      <div class="community_question_title">질문 게시판</div>
      <div class="community_question_bar">
        <div class="community_question_search">
          <Input
        ...
        <div class="community_question_btn">
      ...
      <div class="community_question_list">
        <Table
          class="community_question_list"
...
.community_question_bar {
  display: flex;
  justify-content: right;
  margin: 20px 0 10px 0;
}

.community_question_search {
  display: inline-block;
  width: 25%;
  margin-right: 10px;
}
.community_question_btn {
  display: inline-block;
  /* width: 20%; */
}

.community_question_list {
  display: block;
  margin-top: 20px;
  /* padding: 0 0 20px 0; */
