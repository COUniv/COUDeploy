    ...
    <div class="community" style="float:left">
      ...
      <div class="community_menu">
        ...
        <router-link to="/Request_Board"
          ><div class="community_menu_list_main" name="/RequestBoard">
            요청 게시판
          </div></router-link
        >
      </div>
    </div>
    <div class="community_request" style="float:right">
      <div class="community_request_title">요청 게시판</div>
      <div class="community_request_bar">
        <div class="community_request_search">
          <Input
        ...
        <div class="community_request_btn">
      ...
      <div class="community_request_list">
        <Table
          class="community_request_list"
...
.community_request_bar {
  display: flex;
  justify-content: right;
  margin: 20px 0 10px 0;
}

.community_request_search {
  display: inline-block;
  width: 25%;
  margin-right: 10px;
}
.community_request_btn {
  display: inline-block;
  /* width: 20%; */
}
