      ...
      >
        ...
        <div class="box_container">
          <div class="item_box">
            <div
              class="item"
              v-for="category in problemCategoryList"
              :key="category.title"
              @click="goProblemList(category.id, category.title)"
            >
      ...
      <div class="main-list">
        <div class="left-menu">
              ...
              <div class="filter-difficulty">
                <Dropdown @on-click="filterByDifficulty">
                  ...
                  <Dropdown-menu slot="list">
                    ...
                    <Dropdown-item class="green" name="Low">{{
                      $t("m.Low")
                    }}</Dropdown-item>
                    <Dropdown-item class="orange" name="Mid">{{
                      $t("m.Mid")
                    }}</Dropdown-item>
                    <Dropdown-item class="red" name="High">{{
                      $t("m.High")
                    }}</Dropdown-item>
                  </Dropdown-menu>
                </Dropdown>
          ...
          <table class="problem-list">
            ...
            <tbody v-for="(problem, index) in problemList" :key="index">
              <tr>
                <td id="problem-id">{{ problem._id }}</td>
                <td id="problem-title" @click="redirectToProblem(problem)">
                  {{ problem.title }}
                </td>
                <td
                  :class="[
                    problem.difficulty === 'Low' ? 'green' : '',
                    problem.difficulty === 'Mid' ? 'orange' : '',
                    problem.difficulty === 'High' ? 'red' : ''
                  ]"
                >
                  {{ problem.difficulty }}
                </td>
          ...
          <Pagination
            ...
            :show-sizer="true"
            style="display: flex; justify-content:flex-end; margin: 10px 0 0 0"
          ></Pagination>
        </div>
        <div
          class="right-menu"
...
export default {
  ...
  methods: {
    ...
    redirectToProblem(problem) {
      this.$router
        .push({ name: "problem-details", params: { problemID: problem._id } })
        .catch(() => {});
    },
