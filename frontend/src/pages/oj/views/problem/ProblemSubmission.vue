  ...
  <div class="demo-split">
    <div class="ss_header">
      ...
      <div class="header-left">
        ...
        <div class="problem-name" style="color: #bdbdbd">
          [2022년 3월 코딩 테스트]
        </div>
      ...
      <div class="header-right">
        ...
        <div v-else>
          ...
          <Button
            ...
            >공개로 제출 됨</Button
          >
          <Button v-else type="error" size="large" style="z-index: '1'" disabled
            >비공개로 제출 됨</Button
          >
        </div>
        <div>
    ...
    <Split v-model="split3" v-bind:min="min1" v-bind:max="max1">
      <div slot="left" class="left-split-pane">
        <Tabs value="name1" :animated="false">
          <TabPane :label="problem.title" name="name1">
                ...
                <div v-for="(sample, index) of problem.samples" :key="index">
                  <div class="flex-container-submit-mode sample split-sapple">
                    <div class="sample-input">
                      ...
                      <div style="white-space: pre;" class="input-for-pre">
                        {{ sample.input }}
                      </div>
                    </div>
                ...
                <div v-if="problem.hint">
                  <div class="hide" @click="hintHide()">
                    ...
                    <Button
                      ...
                      ><Icon type="md-eye"
                    /></Button>
                    <Button v-else size="large" class="hint-hide-btn"
                      ><Icon type="md-eye-off"
                    /></Button>
                  </div>
                  <p
          ...
          <Row type="flex" justify="space-between">
            ...
            <Col :span="10">
              <div
                class="status"
                v-if="statusVisible"
                style="margin-top: -615px; margin-left: 15px;"
              >
                <template
                  v-if="
                    !this.contestID ||
              ...
              <div
                v-else-if="problem.my_status === 0"
                style="margin-top: -620px; margin-left: 15px;"
              >
                <Alert type="success" show-icon>{{
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      let func =
        this.$route.name === "problem-submission"
          ? "getProblem"
          : "getContestProblem";
