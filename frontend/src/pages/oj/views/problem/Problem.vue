  ...
  <div class="flex-container">
        ...
        <div id="problem-content" class="markdown-body" v-katex>
          ...
          <div v-for="(sample, index) of problem.samples" :key="index">
            <div class="in-out-container sample">
              <div class="sample-input">
                ...
                <p style="white-space: pre;" class="input-for-pre">
                  {{ sample.input }}
                </p>
              </div>
          ...
          <div v-if="problem.hint">
            <div class="hide" @click="hintHide()">
              ...
              <Button v-if="!hintHidden" size="large" class="hint-hide-btn"
                ><Icon type="md-eye"
              /></Button>
            ...
            <p
              v-html="problem.hint"
              v-bind:style="[
                hintHidden ? { visibility: 'hidden' } : { display: 'block' }
              ]"
            ></p>
          </div>
    ...
    <div id="right-column">
      ...
      <VerticalMenu style="margin-bottom: 20px;">
        ...
        <Button
          v-if="isAuthenticated && isVerifiedEmail"
          type="primary"
          size="large"
          @click="goSubmitView"
          long
          >제출하기</Button
        >
        <Button v-else type="primary" size="large" disabled long
          >제출하기</Button
        >
        <!-- </VerticalMenu-item> -->
      </VerticalMenu>
...
export default {
  ...
  methods: {
    ...
    goSubmitView() {
      if (this.contestID) {
        this.$router
          .push({ name: "contest-problem-submission" })
          .catch(() => {});
      } else {
