  ...
  <div style="display:flex; justify-content:space-between;">
    <div id="contest-card">
      <div style="display: block;">
        <div class="title">{{query.rule_type === '' ? '' : query.rule_type}} {{$t('m.Contests')}}</div>
        <div>
          <ul class="filter">
            <li class="list">
              <Select id="rule" @on-change="onRuleChange" :placeholder="$t('m.Rule')">
            ...
            <li class="list">
              <Select id="status" @on-change="onStatusChange" :placeholder="$t('m.Status')">
            ...
            <li>
              <Input id="keyword" @on-search="changeRoute" v-model="query.keyword" search placeholder="검색어를 입력하세요."></Input>
            </li>
          </ul>
        </div>
      </div>
          ...
          <div>
            <div style="display:flex;">
              ...
              <ul class="detail" style="display:flex;">
                <li>
                  <Tag type="border" :checked=true >{{contest.start_time | localtime('YYYY-M-D HH:mm') }}</Tag>
                </li>
                <!-- <li>
                ...
                <li>
                  ...
                  <Tag type="border" :checkable="checkRule(contest.rule_type)" @on-change="onRuleChange(contest.rule_type)"> {{contest.rule_type}}</Tag>
                </li>
                <li>
                  <Tag type="border" :color="CONTEST_STATUS_REVERSE[contest.status].color">{{$t('m.' + CONTEST_STATUS_REVERSE[contest.status].name.replace(/ /g, "_"))}}</Tag>
                </li>
              </ul>
            </div>
          </div>
      ...
      <Pagination style="float:none; text-align: center;" :total="total" :page-size.sync="limit" @on-change="changeRoute" :current.sync="page" :show-sizer="true" @on-page-size-change="changeRoute"></Pagination>
    </div>
    <div id="user-ranking">
      <div class="main">
...
<script>
  ...
  import { CONTEST_STATUS_REVERSE, CONTEST_TYPE, RULE_TYPE } from '@/utils/constants'
