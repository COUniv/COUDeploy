      ...
      <el-form ref="form" :model="formCodeReview" :rules="rules" label-position="top" label-width="70px">
        ...
        <div class="code_form">
          ...
          <el-form-item prop="code" required>
            <textarea v-model="formCodeReview.code" class="codeArea" placeholder="코드 입력해주세요"
              style="width: 100%; height: 300px; padding-left: 20px; padding-top: 10px"></textarea>
          </el-form-item>
        </div>

        <div class="submit_btn">
          <Button type="primary" size="large" @click="submit">제출
            <Icon id="submit-icon" size="17" type="ios-paper-plane" />
          </Button>
