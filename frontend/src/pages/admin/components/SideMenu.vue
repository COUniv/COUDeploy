<template>
  <el-menu class="vertical_menu"
    ...
    <el-submenu v-if="isSuperAdmin" index="general">
      ...
      <el-menu-item index="/images">이미지 설정</el-menu-item>
    ...
    <el-submenu index="problem" v-if="hasProblemPermission">
      ...
      <el-menu-item index="/problem/tags">문제 태그</el-menu-item>
      <el-menu-item index="/problem/batch_ops">{{$t('m.Export_Import_Problem')}}</el-menu-item>

      <el-menu-item index="/problem/categories">카테고리</el-menu-item>
