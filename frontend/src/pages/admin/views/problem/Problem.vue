  ...
  <div class="problem">
    ...
    <Panel :title="title">
      <el-form ref="form" :model="problem" :rules="rules" label-position="top" label-width="70px">
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item prop="_id" :label="$t('m.Display_ID')"
              ...
              <el-input :placeholder="$t('m.Display_ID')" v-model="problem._id" :readonly="!isSuperAdmin"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="18">
        ...
        <el-form-item v-show="isSuperAdmin" :label="$t('m.Special_Judge')" :error="error.spj">
          <el-col :span="24">
    ...
    methods: {
      ...
      addTag () {
        ...
        if (inputValue) {
          ...
          api.addProblemTag(inputValue).then(res => {
            this.problem.tags.push(res.data.data)
          })
        }
