...
const getters = {
  ...
  isVerifiedEmail: (state, getters) => {
    return getters.user.admin_type === USER_TYPE.ADMIN || getters.user.admin_type === USER_TYPE.SUPER_ADMIN || getters.user.is_email_verify
  }
}
